...
let john = new Employee('John', 'MacIsaac', 'johnmi@protonmail.com', 45);
...
let john2 = new Manager('John', 'MacIsaac', 'johnmi@protonmail.com', 45);
...
/*
  ...
  Progressive managers have all the same properties as managers. Copy the Manager class and rename it to ProgressiveManager. Add the following additional properties:
...
class ProgressiveManager extends Manager {
  ...
  makeWidget() {
    return this.first_name +" "+ this.last_name +" "+"Widget";// ' quotes fail!
  };
  hire(employee) {
    this.reports.push(employee);
    this.updateTitle();
...
// let john3 = new progressiveManager('John', 'MacIsaac', 'johnmi@protonmail.com', 45);
